...
export const MOCK_CARDS: Card[] = [
  {
    ...
    descricao: 'Levantar todos os produtos (novos e legados) do BAU-Orquestrador para o time de QA.',
    ...
    comentarios: [
      { id: 'c1', autor: 'Wagner', texto: 'Iniciando levantamento via planilha legada.', timestamp: '2026-01-15T15:00:00Z' }
    ],
    anexos: [],
  ...
  },
  {
    ...
    comentarios: [
      { id: 'c2', autor: 'Danyla', texto: 'Aguardando correção de lint no commit anterior.', timestamp: '2026-01-16T09:00:00Z' }
    ],
    anexos: [],
