...
// Configure these in cypress.env.json or CI environment variables
const SUPABASE_URL = Cypress.env('SUPABASE_URL') || 'https://YOUR_PROJECT_ID.supabase.co';
const SUPABASE_ANON_KEY = Cypress.env('SUPABASE_ANON_KEY') || 'your_anon_key_here';
