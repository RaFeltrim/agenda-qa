...
*   **Encerramento de Ciclo**: Assistente para mover tarefas concluídas e realizar *carryover* (transferência) de tarefas pendentes para a próxima sprint ou backlog.
...
2.  **Adicione Tarefas**:
    *   *Manual*: Pressione `N` ou clique no botão `+`.
    *   *Via IA*: Clique no botão de importação no cabeçalho e suba um arquivo de texto/PDF.
