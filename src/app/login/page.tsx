...
import { LockOutlined, UserOutlined, ArrowRightOutlined, MailOutlined } from '@ant-design/icons';
    ...
    return (
                <ConfigProvider locale={ptBR}>
                                <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] relative overflow-hidden">
                                                <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-50 rounded-full blur-3xl opacity-50"></div>div>
                                                <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-100 rounded-full blur-3xl opacity-50"></div>div>
                                                ...
                                                <div className="z-10 w-full max-w-[440px] px-6 py-12">
                                                                    <div className="text-center mb-10">
                                                                                            ...
                                                                                            <Title level={2} className="!mb-2">Agenda QA</Title>Title>
                                                                                            <Text type="secondary" className="text-base">Mantenha seu fluxo de trabalho sincronizado</Text>Text>
                                                                    </div>div>
